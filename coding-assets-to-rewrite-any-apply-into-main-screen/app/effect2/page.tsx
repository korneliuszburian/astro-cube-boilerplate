...
const assetMap: Record<AssetSet, { raw: string; depth: string; edge: string }> = {
  pictures_1: { raw: require('../../assets/pictures_1/raw-2.png').default.src, depth: require('../../assets/pictures_1/depth-2.png').default.src, edge: require('../../assets/pictures_1/edge-2.png').default.src },
  pictures_2: { raw: require('../../assets/pictures_2/raw-2.png').default.src, depth: require('../../assets/pictures_2/depth-2.png').default.src, edge: require('../../assets/pictures_2/edge-2.png').default.src },
  pictures_3: { raw: require('../../assets/pictures_3/raw-2.png').default.src, depth: require('../../assets/pictures_3/depth-2.png').default.src, edge: require('../../assets/pictures_3/edge-2.png').default.src },
  pictures_4: { raw: require('../../assets/pictures_4/raw-2.png').default.src, depth: require('../../assets/pictures_4/depth-2.png').default.src, edge: require('../../assets/pictures_4/edge-2.png').default.src },
  pictures_5: { raw: require('../../assets/pictures_5/raw-2.png').default.src, depth: require('../../assets/pictures_5/depth-2.png').default.src, edge: require('../../assets/pictures_5/edge-2.png').default.src },
};
...
const Scene = ({ assetSet }: { assetSet: AssetSet }) => {
  ...
  const edgeMapPath = assetMap[assetSet].edge;
  const [rawMap, depthMap, edgeMap] = useTexture([rawMapPath, depthMapPath, edgeMapPath], () => {
    setIsLoading(false);
  ...
  const { material, uniforms } = useMemo(() => {
    ...
    const mask = oneMinus(tEdgeMap).mul(flow).mul(vec3(uAvgColor.x, uAvgColor.y, uAvgColor.z).mul(1.5));
  ...
  }, [rawMap, depthMap, edgeMap, avgColor]);
